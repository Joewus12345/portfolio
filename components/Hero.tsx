...
const Hero = () => {
  return (
    <div className="pb-20 pt-36">
       ...
       */}
      <div
        className="h-screen w-full bg-black-100 dark:bg-grid-white/[0.03] bg-grid-[#C1C2D3]/[0.2]
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <p className="uppercase tracking-widest text-xs text-center dark:text-blue-100 max-w-80 text-black">
